...
export const BotonAcciones = (props) => {
    ...
    return(
      ...
      <Grid item xs={12} sm="auto">
        <ModificarPractico anio={props.anio} idcursada={props.idcursada} semestre={props.semestre} 
...
abrir={props.abrir}
      ...
      <Grid item xs={12} sm="auto"> 
        <BorrarPractico anio={props.Anio} idcursada={props.idcursada} semestre={props.semestre} 
       cursada={props.cursada} practico={props.practico}
