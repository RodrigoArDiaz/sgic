...
//Datos de prueba
function crearDatosPrueba(materia,carrera, planEstudio,codigoSIU, estadomat, estadoplan, estadocar, codplan, codcar) {
    return { materia,carrera, planEstudio,codigoSIU, estadomat, estadoplan, estadocar, codplan, codcar};
}
    ...
    return (
        ...
        <IconButton 
            ...
            <Dialog 
                ...
                fullWidth
            >
                <DialogTitle>Agregar parámetro de examen - {props.catedra}</DialogTitle>
                <DialogContent>
