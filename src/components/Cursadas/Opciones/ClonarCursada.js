...
function DevolverBoton(){
    ...
    if(eanio==='1'&& esemestre==='1'&& efinicio==='1'&& effin==='1'&& eprograma==='1'&&
    etieneg==='1'&& emaxintg==='1'&& eescala==='1'&& epnt==='1' && ecalculo==='1'){
      ...
      ...form, [e.target.name]: e.target.value
                        ...
                        <FormControl 
                            ...
                            error= {errors.tieneg ? true : false}>
                               ...
                               {<BotonTieneGrupo Cambio={CambioTG} vpd={props.cursada.TieneGrupos}/>}
                        ...
                        <FormControl 
                            ...
                            disabled= {form.tieneg==="N" || form.tieneg===""||etieneg!=='1' ? true : false}>
      ...
      ...form, [e.target.name]: e.target.value
                                ...
                                onBlur = {(e)=>{
                                    ...
                                    if(!form.maxintg.trim()){
                                        ...
                                        setErrors({...errors,     [e.target.name]: "El campo es requerido."});
                                    setMx('2');
                                    }
                                    else if(!regex.test(form.maxintg.trim())){
                                        setErrors({...errors,  [e.target.name] : "El campo tiene un formato incorrecto."});
                                        setMx('2');
                                    }
                                    else if(parseInt(form.maxintg.trim())<1){
                                        setErrors({...errors,  [e.target.name] : "El campo debe ser mayor."});
                                        setMx('2');
                                    }
                                    else{
                                        setMx('1');
                        ...
                        <FormControl 
                            ...
                            error= {errors.calculo ? true : false}>
                                ...
                                {<BotonTipoCalculo Cambio={CambioTipoCalculo} vpd={props.cursada.CalculoPracticos}/>}
