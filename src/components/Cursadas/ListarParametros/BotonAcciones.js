...
export const BotonAcciones = (props) => {
    ...
    return(
      ...
      <Grid item  xs={12} sm="auto">
        <ModificarParametro idcursada={props.idcursada} parametro={props.parametro}
      ...
      <Grid item  xs={12} sm="auto">
        <BorrarParametro parametro={props.parametro} 
        refrescar={props.refrescar} 
        abrir={props.abrir} mensaje={props.mensaje} tipo={props.tipo}
        idcursada={props.idcursada}
        materia={props.materia} nombremateria={props.nombremateria}
        />
      </Grid>
