...
export const BotonAcciones = (props) => {
    ...
    return(
      ...
      <Grid item xs={12} sm="auto">
        <AgregarMateriaCatedra idcatedra={props.idcatedra} catedra={props.catedra} idusuario={props.idusuario}
        refrescar={props.refrescar} 
        abrir={props.abrir} mensaje={props.mensaje} tipo={props.tipo}
        materia={props.materia} plan={props.plan} carrera={props.carrera}
