...
<Grid item xs={9}  > 
    <BuscarCursadas actualizar={BuscarCur} filasxpagina={filasxpagina} idmateria={props.idmateria}  />
</Grid>

                <Grid sx={{mt:2}} item xs={3} >
                    <CrearCursada refrescar={Refrescar}
...
{(cargando===false) &&<Grid
              ...
              pt={2}
            >
                <CursadaLista filas={filas} filasxpagina={filasxpagina} pagina={pagina} 
                paginacion={paginacion} resultados={resultados} 
                actualizarpagina={CambioPagina} actualizarfilas={CambioFPP} 
                refrescar={Refrescar}
                
                abrir={setAbrir} mensaje={setMensaje} tipo={setTipo} Materia={props.Materia}
                />
            </Grid>                      }
