...
import MateriasLista from './MateriasListaListar';
...
const [tipo, setTipo] = React.useState();
    ...
    function Refrescar(){
      setCargando(true);
      consultas(datosconsulta,'http://127.0.0.1:8000/api/listarmaterias').then(response=>{
...
/*
    ...
    //pidCa:props.idcatedra,
        ...
        consultas(data,'http://127.0.0.1:8000/api/listarmaterias').then(response=>{
...
{(cargando===false) &&<Grid
              ...
              pt={8}
            >
                <MateriasListaListar filas={filas} filasxpagina={filasxpagina} pagina={pagina} 
