...
const [tipo, setTipo] = React.useState();
    ...
    function Refrescar(){
      setCargando(true);
      consultas(datosconsulta,'http://127.0.0.1:8000/api/listaruscat').then(response=>{
...
/*
    ...
    pidCa:props.idcatedra,
        ...
        consultas(data,'http://127.0.0.1:8000/api/listaruscat').then(response=>{
...
{(cargando===false) &&<Grid
              ...
              pt={2}
            >
                <UsuariosListaListar filas={filas} filasxpagina={filasxpagina} pagina={pagina} 
