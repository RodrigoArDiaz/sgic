...
if (props.filas.res.length<1) return(<h4 >Consulte al administrador para asociarse a una cátedra</h4>);

//console.log(props.filas.res);

  return (<Grid container pt={1} spacing={2}>
    {
    props.filas.res.map((row) => {
      
    return(
      <Grid item xs={6} >
  <TarjetaCatedra catedra={row.Catedra} idcatedra={row.IdCatedra} salto={props.salto} setCat={props.setCat}
  setT={props.setT}
  />
  </Grid>
    );
