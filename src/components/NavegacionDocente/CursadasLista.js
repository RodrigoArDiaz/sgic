...
//console.log('Materia:'+props.Materia);
...
<Grid container pt={1} spacing={2}>
  ...
  return(
    <Grid item xs={6} >
<TarjetaCursada fila={props.Materia} idcursada={row.IdCursada} anio={row.Anio} sem={row.Semestre}
salto={props.salto} setCur={props.setCur}
setT={props.setT} cur={row}/>
</Grid>
  );
  })}
