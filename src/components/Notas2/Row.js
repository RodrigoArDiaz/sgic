          ...
          <TableRow sx={{ '& > *': { borderBottom: 'unset' } }}>
            <TableCell>
              <IconButton
                ...
                setE('3');
                Responses.consultas(data,'http://127.0.0.1:8000/api/listarintegrantes').then(response=>{
            ...
            {props.res2.map((column) => {
                                    ...
                                    console.log(column.NMA);
                                      return (<TableCell key={column.id} align={column.align}>
                                        {column.format && typeof value === 'number'
                                          ? column.format(value)
                                          : <BotonNotaGrupo cursada={props.cursada} Nota={value}
                                          IdGrupo={props.res.IdGrupo} IdPractico={column.idp}
