...
//Datos de prueba
function crearDatosPrueba(apellidos,nombres,dni,email,estado,usuario,libreta) {
    return { apellidos,nombres,dni,email,estado,usuario,libreta };
}
  
  const rows = [
    crearDatosPrueba("Diaz", "Rodrigo", "39359920","diazrodrigoar@gmail.com","A","diazrod","1410972"),
    crearDatosPrueba("Luchesse", "Augusto Gustavo","20300100","gustavo@gmail.com","B","lucheseaug","1410100"),
  ];
