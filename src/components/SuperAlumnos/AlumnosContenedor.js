...
const [tipo, setTipo] = React.useState();
    ...
    function Refrescar(){
      setCargando(true);
      consultas(datosconsulta,'http://127.0.0.1:8000/api/buscaralumnos').then(response=>{
    ...
    function BuscarAl(parametro){
       ...
       setDC(parametro);
      setCargando(true);
      consultas(parametro,'http://127.0.0.1:8000/api/buscaralumnos').then(response=>{
...
setCargando(true);
   ...
   consultas(datos,'http://127.0.0.1:8000/api/buscaralumnos').then(response=>{
...
/*
    ...
    Limite:filasxpagina,*/
        ...
        consultas(data,'http://127.0.0.1:8000/api/buscaralumnos').then(response=>{
...
<Grid item xs={12}  > 
    <BuscarAlumnos actualizar={BuscarAl} filasxpagina={filasxpagina}  />
</Grid>
...
{(cargando===false) &&<Grid
              ...
              pt={2}
            >
                <AlumnosLista filas={filas} filasxpagina={filasxpagina} pagina={pagina} 
