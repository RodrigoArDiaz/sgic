...
const [tipo, setTipo] = React.useState();
    ...
    function Refrescar(){
      setCargando(true);
      consultas(datosconsulta,'http://127.0.0.1:8000/api/buscarusnocat').then(response=>{
    ...
    function BuscarUsCat(parametro){
       ...
       setDC(parametro);
      setCargando(true);
      consultas(parametro,'http://127.0.0.1:8000/api/buscarusnocat').then(response=>{
...
setCargando(true);
   ...
   consultas(datos,'http://127.0.0.1:8000/api/buscarusnocat').then(response=>{
 ...
 React.useEffect(() => {
    ...
    pidCa:props.idcatedra,
        ...
        consultas(data,'http://127.0.0.1:8000/api/buscarusnocat').then(response=>{
...
<Grid item xs={12}  > 
    <BuscarUsuarios actualizar={BuscarUsCat} filasxpagina={filasxpagina} idcatedra={props.idcatedra} />
</Grid>
            </Grid>
...
{(cargando===false) &&<Grid
              ...
              pt={2}
            >
                <UsuariosLista filas={filas} filasxpagina={filasxpagina} pagina={pagina} 
