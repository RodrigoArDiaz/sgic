    ...
    function DevolverBoton(){
        ...
        if(erol==='1'){
            return(
                ...
                <Button variant='contained'  onClick={ModificarUsuarioRol}>Modificar</Button>
            );}
        
        else{
        
            return(
                <Button variant='contained' disabled >Modificar</Button>);
        }
        }
        ...
        consultas(data,'http://127.0.0.1:8000/api/modificaruscat').then(response=>{
